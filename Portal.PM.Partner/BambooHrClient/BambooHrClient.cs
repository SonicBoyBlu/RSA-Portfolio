...
namespace BambooHrClient
{
    public interface IBambooHrClient
    {
        ...
        Task<List<BambooHrEmployee>> GetPayrollHours();
...
    <end>{2}</end>
    ...
    <note>{2}</note>
        ...
        public async Task<List<BambooHrEmployee>> GetPayrollHours()
        {
            string url = "reports/payroll-hours?format=json&payIntervalFilter%5BpayScheduleFilter%5D=7&payIntervalFilter%5BpayPeriodId%5D=18";
            ...
            request.AddHeader("x-csrf-token", "b00ece6358473b819ea0c847ee5ce6991b6889a2df01ae97895c205930e8886c220596b71b3f5c753d2cade21fc4cc4b1b171a504b4e1f62e93d319dbb6974cd");
